...
/**
 * Simplified interface for C++ <code>IInArchive</code>. For binding of original
 * 7-Zip C++ interface see {@link ISevenZipInArchive}.
 * 
 * 
...
public interface ISimpleInArchive {
	 ...
	 * 
	 * @throws SevenZipException
	 *             error occurs. See {@link SevenZipException#getMessage()} for
	 *             details.
	 */
